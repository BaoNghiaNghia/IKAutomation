    ...
    public sealed class VietnameseUserMessageLocalizer : IUserMessageLocalizer
    {
        private static readonly IReadOnlyDictionary<UiMessageKey, string> Messages =
            new Dictionary<UiMessageKey, string>
            {
                ...
                [UiMessageKey.PreflightNoReadyTeam] = "Kiểm tra ban đầu hoàn tất; chưa có đội được phép nào sẵn sàng nên thiết bị sẽ chờ lần kiểm tra tiếp theo.",
                ...
                [UiMessageKey.YieldedUntilScheduledCheck] = "Chưa có đội được phép nào sẵn sàng; thiết bị đã nhường lượt và sẽ được kiểm tra lại theo lịch.",
