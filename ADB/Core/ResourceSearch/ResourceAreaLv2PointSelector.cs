...
namespace ADB_Tool_Automation_Post_FB.Core.ResourceSearch
{
    ...
    {
        private static readonly Point[] BasePoints = new[] { new Point(210,261),new Point(178,276),new Point(199,306),new Point(225,279),new Point(302,265),new Point(274,294),new Point(268,327),new Point(279,357),new Point(304,356),new Point(342,339),new Point(323,302),new Point(321,240),new Point(339,267),new Point(348,292),new Point(369,303),new Point(428,258),new Point(461,245),new Point(469,177),new Point(422,201),new Point(525,204),new Point(517,245),new Point(549,267),new Point(567,266),new Point(609,261),new Point(609,218) };
