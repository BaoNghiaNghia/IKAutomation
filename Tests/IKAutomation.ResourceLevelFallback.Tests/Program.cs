...
internal static class Program
{
    ...
    sealed class FakeSearch:IResourceSearchExecutionService{public int Calls;public ResourceSearchOutcome Default=ResourceSearchOutcome.ResourceLocated;public string NotFoundVariant="VerifiedRetryPanelStayedOpen";public bool NotFoundToastVerified=true;public Queue<ResourceSearchOutcome> Outcomes=new Queue<ResourceSearchOutcome>();public List<ResourceSearchExecutionRequest> Requests=new List<ResourceSearchExecutionRequest>();public CancellationTokenSource CancelAfterNotFound;public Task<ResourceSearchExecutionResult> ExecuteAsync(string d,ResourceSearchExecutionRequest r,CancellationToken t){t.ThrowIfCancellationRequested();Calls++;Requests.Add(r);var o=Outcomes.Count>0?Outcomes.Dequeue():Default;var reason=NotFoundVariant=="SearchOtherRegion"?ResourceSearchFailureReason.SearchOtherRegion:NotFoundVariant=="TargetLevelTooLow"?ResourceSearchFailureReason.TargetLevelTooLow:ResourceSearchFailureReason.ResourceUnavailable;var x=new ResourceSearchExecutionResult{Outcome=o,Success=o==ResourceSearchOutcome.ResourceLocated,FinalState=o==ResourceSearchOutcome.ResourceLocated?GameState.ResourcePopup:GameState.ResourceSearchPanel,NotFoundToastVerified=o==ResourceSearchOutcome.ResourceNotFound&&NotFoundToastVerified,MatchedNotFoundVariant=o==ResourceSearchOutcome.ResourceNotFound?NotFoundVariant:null,FailureReason=o==ResourceSearchOutcome.ResourceNotFound?reason:ResourceSearchFailureReason.None,Message=o.ToString()};if(o==ResourceSearchOutcome.ResourceNotFound)CancelAfterNotFound?.Cancel();return Task.FromResult(x);}}
