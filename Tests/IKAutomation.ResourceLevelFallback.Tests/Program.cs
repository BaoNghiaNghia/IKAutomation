...
internal static class Program
{
    ...
    static int Main()
    {
        ...
        Run("Account ceiling outside priority is a business exhaustion", CeilingOutsidePriorityExhausts);
    ...
    static void CeilingOutsidePriorityExhausts(){var h=new H();h.Config.UnavailableLevel=7;h.Config.ObservedLevel=4;var p=new ResourceLevelFallbackPolicy{Levels=new[]{7},AttemptsPerLevel=1,StopOnFirstLocated=true,WaitForToastClearBetweenAttempts=true};var r=Go(h,p);Eq(ResourceLevelFallbackOutcome.ResourceLevelsExhausted,r.Outcome,"outcome");Eq(0,h.Search.Calls,"search count");Is(r.ErrorMessage==null,"technical error");}
