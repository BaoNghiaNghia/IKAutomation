...
internal static class Program
{
    ...
    {
        public Func<int,TemplateId,ImageRegion?,ImageMatchResult> Rule; public readonly List<(int frame,TemplateId id,ImageRegion? roi)> Calls=new List<(int,TemplateId,ImageRegion?)>(); public int ActionX=20; public TeamNumber SelectedTeam=TeamNumber.Team4; public bool PanelAfter=false,WorldAfter=true,SelectedAfter=false,BusyAfter=false,TimerAfter=false,DynamicRetryAction=false;
