...
internal static class Program
{
    ...
    private static void CompareUsesTeam4Roi() { var h=new Harness(); Execute(h); Eq(420,h.Comparer.Regions[0].Value.Y,"dynamic ROI Y"); Is(h.Comparer.Regions[0].Value.Height!=70,"WorldMap row height leaked into dispatch"); }
