...
internal static class Program
{
    ...
    static void AvailabilityBusyTeam3Exists(){var f=new AvailabilityFixture();f.Matcher.PresentRows.Remove(4);f.Matcher.ReadyRows.Add(2);f.Matcher.BusyRows.UnionWith(new[]{1,3});var r=f.Service.CheckAsync("LDPlayer",default(CancellationToken)).GetAwaiter().GetResult();Is(r.ExistingTeams.Contains(TeamNumber.Team3),"busy Team3 omitted");Is(!r.ReadyTeams.Contains(TeamNumber.Team3),"busy Team3 marked ready");}
